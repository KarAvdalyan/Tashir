  ...
  <form>
    <div class="form-group row">
      ...
      <div class="col-xs-6" id="" style="margin-top:43px;">
         <input id="sub_update_product" type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#update_product"  type="submit" style="width:40%;" value="Մուտքագրել">
      </div>
                                                                 <!-- #update_product -->
      ...
      <div class="col-xs-6" id="" style="margin-top:90px;">
         <input id="sub_update_project" type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#update_project"  type="submit" style="width:40%;" value="Մուտքագրել">
      </div>
                                                                 <!-- #update_project -->
      ...
      <div class="col-xs-6" id="" style="margin-top:9px;">
         <input id="sub_update_supplier" type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#update_supplier"  type="submit" style="width:40%;" value="Մուտքագրել">
      </div>
                                                                 <!-- #update_supplier -->
