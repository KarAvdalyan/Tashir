...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a class="btn btn-primary btn-md" id="insert" data-toggle="modal" data-target="#payment" href="#">Գործարք</a>

                                <!-- Trigger the Product full with a button -->
     <a class="btn btn-primary btn-md" data-toggle="modal" data-target="#add_product" href="#">Պրոդուկտի մուտքագրում</a>

                                <!-- Trigger the project full with a button -->
     <a class="btn btn-primary btn-md" data-toggle="modal" data-target="#add_project" href="#">Պրոյեկտի մուտքագրում</a>

                                <!-- Trigger the ad_supplier full with a button -->
     <a class="btn btn-primary btn-md" data-toggle="modal" data-target="#add_supplier" href="#">Մատակարարի մուտքագրում</a>
  </div>
</div>
...
<div class="dropdown">
  <button class="dropbtn btn btn-primary btn-md">Դիտում</button>
    <div class="dropdown-content">
              ...
              <a id="show_product"  class="btn btn-primary btn-md" href="#">Պրոդուկտի Դիտում</a>

                                  <!-- Trigger the show project full with a button -->
              <a id="show_project" class="btn btn-primary btn-md" href="#">Պրոյեկտի Դիտում</a>

                                  <!-- Trigger the show  show supplier full with a button -->
              <a id="show_supplier"  class="btn btn-primary btn-md" href="#">Մատակարարի Դիտում</a>
